...
//InitialState for this specific page, should not be the same as InitialState in Form.js
 ...
 // If the component changes (i.e. if a search is entered)...
  componentDidUpdate: function() {
    ...
    helper.runQuery(term, startYear, endYear).then(function(data) {
...
// This function allows childrens to update the parent.
  setTerm: function(term, startYear, endYear) {
    ...
    console.log("Main 58"+term+ startYear+ endYear);
  },
  
      // handling saving article
    handleSave: function(history){
        // send saved article to db
        helpers.postArticle(history).then(function(){
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-sm-12">
            ...
            <Results address={this.state.results}handleSave={this.handleSave} />

          </div>

        <div className="col-sm-12">

          <History history={this.state.history}deleteArticle={this.deleteArticle} />
